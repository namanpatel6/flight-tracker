...
async function updateFlightData(flightId: string, flightInfo: Flight): Promise<void> {
  await db.flight.update({
    ...
    data: {
      ...
      departureTime: flightInfo.departure.estimated ? new Date(flightInfo.departure.estimated) : (flightInfo.departure.actual ? new Date(flightInfo.departure.actual) : undefined),
      arrivalTime: flightInfo.arrival.estimated ? new Date(flightInfo.arrival.estimated) : (flightInfo.arrival.actual ? new Date(flightInfo.arrival.actual) : undefined),
